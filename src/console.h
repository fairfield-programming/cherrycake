...
namespace console
{
    ...
    const Command commands[] = {
        Command("help", "The help command stores information about how the cherrycake cli works.", {CommandArg("command", "Including this argument displays the documentation for the command with a name matching the argument.", "build")}),
        Command("run", "The run command executes the code, in interpretted mode, of the file specified as the first argument.", {CommandArg("file", "This argument is required and used so that the cherrycake cli can know where your code is stored.", "example.chry", false)})};
